      ...
      <section className="relative py-24">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          {cityLoading ? (
            ...
            <>
              <h1 className="text-5xl md:text-6xl font-bold mb-6">{city?.name}</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-charcoal mb-4">Lieux d'Intérêt</h2>
              ...
              places?.map((place) => (
                ...
                >
                  <Card className="group cursor-pointer bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    ...
                    <CardContent className="p-6">
                      <h3 className="text-xl font-bold text-charcoal mb-3">{place.name}</h3>
